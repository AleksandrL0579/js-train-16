...
function filterStudentsByGrade(students, grade) {
  console.log(`Відфільтровано студентів з оцінкою ${grade}:`);
...
function compareArrays(arr1, arr2) {
  ...
  console.assert(arr1String === arr2String, "Масиви не однаковi.");
...
function traceBackward(n) {
  ...
  if (n > 1) {
    ...
    console.log(
      "Reached the base case (n = 1). Call stack:",
      new Error().stack
    );
  }
...
function calculateTotalPrice(products) {
  ...
  console.log("Загальна вартість товарів:", b);
  const endTime = new Date();
  const c = endTime - a;
  console.log("Час виконання:", c, "мс");
